...
func (this *CalendarItem) SetEndDate(v time.Time)       { this.endDate = v }
func (this *CalendarItem) EndDate() time.Time           { return this.endDate }
...
// DTSTAMP:20141216T010000Z
// DTSTART:20141216T010000Z
// DTEND:20141230T010000Z
// SUMMARY:这个是12月16日开始的日程
// END:VEVENT

func (this *CalendarItem) ICalString(target string) string {
	s := "BEGIN:VEVENT\n"
	...
	if this.Freq() != "" {
		s += "RRULE:FREQ=" + this.Freq() + ";COUNT=10\n"
	}
	s += "END:VEVENT\n"
	return s
}
...
func (this *Todo) ICalString(target string) string {
	...
	s += "UID:" + this.Id() + "\n"
	s += "SUMMARY:" + EscapeTextType(this.Summary()) + "\n"
	if !this.DueDate().IsZero() {
		s += EncodeDateProperty("DUE", this.DueDate()) + "\n"
	}
